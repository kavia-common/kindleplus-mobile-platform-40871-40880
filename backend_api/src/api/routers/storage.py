...
@router.post("/presign/upload", response_model=PresignUploadResponse, summary="Get presigned upload URL", description="Issue a presigned URL to upload a file to configured storage backend.", tags=["Storage"])
...
@router.post("/presign/download", response_model=PresignDownloadResponse, summary="Get presigned download URL", description="Issue a presigned URL to download a file from configured storage backend.", tags=["Storage"])
